...
define
   ...
   NameText         = text(glue:n width:15 height:2
			   %handle:NameTextHandle
			   return:PlayerName borderwidth:0 highlightthickness:0)
   ...
   Window
   proc {GetUserChoice Name StartingPokemoz}
